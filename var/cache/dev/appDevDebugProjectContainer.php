...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fc_platform.antispam' => 'getFcPlatform_AntispamService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\FC\\PlatformBundle\\Entity'))), 'FC\\PlatformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('FCPlatformBundle' => 'FC\\PlatformBundle\\Entity'));
    ...
    /**
     * Gets the 'fc_platform.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FC\PlatformBundle\Antispam\FCAntispam A FC\PlatformBundle\Antispam\FCAntispam instance.
     */
    protected function getFcPlatform_AntispamService()
    {
        return $this->services['fc_platform.antispam'] = new \FC\PlatformBundle\Antispam\FCAntispam($this->get('swiftmailer.mailer.default'), 'en', 50);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\FC\\PlatformBundle/Resources/views'), 'FCPlatform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bceb5a5e515cd616212b6781fb5b8c1dc951cdb5');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56afeb4fdc6ea2.84641728')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FCPlatformBundle' => 'FC\\PlatformBundle\\FCPlatformBundle',
            ...
            'secret' => 'bceb5a5e515cd616212b6781fb5b8c1dc951cdb5',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'bceb5a5e515cd616212b6781fb5b8c1dc951cdb5',
